...
TITLE; FOOTNOTE;
TITLE "Bijesh Mishra, Assignment 6 & 7, Problem 4";
/* Data Year 2020 */
DATA y20;
...
* RUN; * QUIT;
* INPUT Team $ 1-25 FG 26-30 FGA 31-35 P3 36-40 FT 41-45 conf;

TITLE "Bijesh Mishra, Assignment 6 & 7, Problem 4 (a)";
PROC SORT DATA = combo; BY TEAM;
PROC REPORT DATA = combo;
COLUMN Team fg p3 ft;
BY TEAM;
DEFINE Team/ GROUP;
DEFINE fg / 'Field Goals';
DEFINE p3 / '3 Point Field Goals';
DEFINE ft / 'Free Throws';
RUN; QUIT;

TITLE "Bijesh Mishra, Assignment 6 & 7, Problem 4 (b)";
PROC REPORT DATA = combo;
COLUMN Team Year fg p3 ft;
DEFINE Team / GROUP;
DEFINE YEAR / GROUP;
DEFINE fg / 'Field Goals';
DEFINE p3 / '3 Point Field Goals';
...
TITLE "Bijesh Mishra, Assignment 6 & 7, Problem 4 (c)";
PROC REPORT DATA = combo;
COLUMN  Year Team fg p3 ft;
DEFINE Team / GROUP;
DEFINE YEAR / GROUP;
DEFINE fg / 'Field Goals';
DEFINE p3 / '3 Point Field Goals';
...
/* Output Combined Data to Assignment 13 */
