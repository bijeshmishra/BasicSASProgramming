...
Brooklun Nets			 2908 6498 941  1291
...
Altanta Hawks            2937 6281 895  1417
...
;
TITLE "Assignment 2, Problem 2, Bijesh Mishra";
PROC SORT DATA = y20; 
BY DESCENDING ft;
PROC print DATA = y20;
RUN; QUIT;
...
Cleveland Cavaliers      2778 6175 720  1200
;
TITLE "Assignment 2, Problem 3, Bijesh Mishra";
PROC SORT DATA = bbcombo;
BY fg;
PROC PRINT DATA = bbcombo NOOBS;
VAR Team fg;
RUN; QUIT;

TITLE "Assignment 2, Problem 4, Bijesh Mishra";
PROC UNIVARIATE DATA = bbcombo CIBASIC (ALPHA = 0.08)NORMAL;
VAR ft fg;
HISTOGRAM fg/NORMAL;
OUTPUT OUT = summary MEAN = meanFT meanFG MEDIAN = medianFT medianFG;
