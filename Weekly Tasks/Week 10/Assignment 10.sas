...
TITLE "Bijesh Mishra, Assignment 10, Problem 1 ";
/*
PROC IMPORT OUT = WORK.Jan2021
DATAFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\Assign10Data.xlsx"
DBMS = EXCEL REPLACE ;
SHEET = "Jan2021";
GETNAMES = YES;
RUN; QUIT;
...
PROC IMPORT OUT = WORK.Jan2021
DATAFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\Jan2021.csv"
DBMS = CSV REPLACE;
DATA WORK.Jan2021;
SET WORK.Jan2021;
Month = "Jan";
PROC IMPORT OUT = WORK.Feb2021
DATAFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\Feb2021.csv"
DBMS = CSV REPLACE;
DATA WORK.Feb2021;
SET WORK.Feb2021;
Month = "Feb";
PROC IMPORT OUT = WORK.March2021
DATAFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\March2021.csv"
DBMS = CSV REPLACE;
DATA WORK.March2021;
SET WORK.March2021;
Month = "Mar";
PROC IMPORT OUT = WORK.April2021
DATAFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\April2021.csv"
DBMS = CSV REPLACE;
DATA WORK.April2021;
SET WORK.April2021;
Month = "Apr";
...
TITLE "Bijesh Mishra, Assignment 10, Problem 2 ";
LIBNAME CLASS "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data";
DATA CLASS.MESO2021_2;
SET WORK.Jan2021 WORK.Feb2021 WORK.March2021 WORK.April2021;
LABEL Month = "Month"
      DAY = "Day"
...
TITLE "Bijesh Mishra, Assignment 10, Problem 3 "; 
*** TEMPHUMIDWIND21.SAS *** ; 
data mesonet21 ; 
...
TITLE "Bijesh Mishra, Assignment 10, Problem 4";
PROC SORT DATA = CLASS.MESO2021_2; BY Month;
PROC SORT DATA = work.mesonet21; BY Month;
DATA CLASS.MESONET1_4;
MERGE CLASS.MESO2021_2 work.mesonet21;
BY Month Day;
...
TITLE "Bijesh Mishra, Assignment 10, Problem 5 (a)";
PROC MEANS DATA = CLASS.MESONET1_4;
CLASS Month;
VAR MaxTemp MinTemp MaxHumid MinHumid SpeedAvg Rain_In StnPressur Solar_Mj_M2 SodSoil BareSoil;
OUTPUT OUT = work.sumstats MEAN = MeanMaxTemp MeanMinTemp MeanMaxHumid MeanMinHumid MeanSpeedAvg 
						 		  MeanRain_In MeanStnPressur MeanSolar_Mj_M2 MeanSodSoil MeanBareSoil;

TITLE "Bijesh Mishra, Assignment 10, Problem 5 (b)";
/*
PROC EXPORT DATA = work.sumstats
OUTFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Data\sumstats_ASSIGN10DATA.XLSX"
DBMS = EXCEL;
SHEET =  "WORK.SUMSTAT";
RUN; QUIT;
*/
...
PROC EXPORT DATA = work.sumstats
OUTFILE = "C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Assignments\Assignment 10\sumstats_ASSIGN10DATA.csv"
DBMS = csv REPLACE;
RUN; QUIT;
...
DATA Assgn11.MESONET1_4;
SET CLASS.MESONET1_4;
RUN; QUIT;

/* Export Permanent dataset to Assignment 13 */
LIBNAME CLASS " C:\Users\bmishra\Dropbox\OSU\PhD\Fall 2021\STAT5193 SAS R\SAS\Assignments\Assignment 13";
DATA CLASS.MESO1_4;
SET CLASS.MESONET1_4;
RUN; QUIT;
